...
class Timer extends Animation {
  ...
  update() {
    ...
    if ( this.converted != old ) {
      ...
      localStorage.setItem( 'rubikCube_time', this.deltaTime );
      this.setText();
...
class Storage {
  ...
  constructor( game ) {
    ...
    const userVersion = localStorage.getItem( 'rubikCube_version' );
    ...
    if ( ! userVersion || userVersion !== window.gameVersion ) {
      ...
      this.migrateScores();
      localStorage.setItem( 'rubikCube_version', window.gameVersion );
  ...
  loadGame() {
    ...
    try {
      ...
      const gameInProgress = localStorage.getItem( 'rubikCube_playing' ) === 'true';

      if ( ! gameInProgress ) throw new Error();

      const gameCubeData = JSON.parse( localStorage.getItem( 'rubikCube_savedState' ) );
      const gameTime = parseInt( localStorage.getItem( 'rubikCube_time' ) );
  ...
  saveGame() {
    ...
    localStorage.setItem( 'rubikCube_playing', gameInProgress );
    localStorage.setItem( 'rubikCube_savedState', JSON.stringify( gameCubeData ) );
    localStorage.setItem( 'rubikCube_time', gameTime );

  }

  clearGame() {

    localStorage.removeItem( 'rubikCube_playing' );
    localStorage.removeItem( 'rubikCube_savedState' );
    localStorage.removeItem( 'rubikCube_time' );
  ...
  loadScores() {
    ...
    try {
      ...
      const scoresData = JSON.parse( localStorage.getItem( 'rubikCube_scores' ) );
  ...
  saveScores() {
    ...
    localStorage.setItem( 'rubikCube_scores', JSON.stringify( scoresData ) );

  }

  clearScores() {

    localStorage.removeItem( 'rubikCube_scores' );
  ...
  migrateScores() {
    ...
    try {
      ...
      const scoresData = JSON.parse( localStorage.getItem( 'rubikCube_scoresData' ) );
      const scoresBest = parseInt( localStorage.getItem( 'rubikCube_scoresBest' ) );
      const scoresWorst = parseInt( localStorage.getItem( 'rubikCube_scoresWorst' ) );
      const scoresSolves = parseInt( localStorage.getItem( 'rubikCube_scoresSolves' ) );
      ...
      localStorage.removeItem( 'rubikCube_scoresData' );
      localStorage.removeItem( 'rubikCube_scoresBest' );
      localStorage.removeItem( 'rubikCube_scoresWorst' );
      localStorage.removeItem( 'rubikCube_scoresSolves' );
  ...
  loadPreferences() {
    ...
    try {
      ...
      const preferences = JSON.parse( localStorage.getItem( 'rubikCube_preferences' ) );
  ...
  savePreferences() {
    ...
    localStorage.setItem( 'rubikCube_preferences', JSON.stringify( preferences ) );

  }

  clearPreferences() {

    localStorage.removeItem( 'rubikCube_preferences' );
